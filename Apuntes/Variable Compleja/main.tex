...
% --- Márgenes y espaciado global (igual que en EDO) ---
\usepackage[a4paper,margin=3.5cm]{geometry}
\usepackage{setspace}
\setstretch{1.3}
\raggedbottom % Evita estirado vertical entre páginas
\setlength{\parindent}{0pt}
\setlength{\parskip}{0.8em}
\usepackage{microtype} % Mejor justificación y kerning
...
\usepackage{xcolor}
\usepackage{enumitem}
\setlist{itemsep=0.2em, topsep=0.3em} % listas compactas (opcional, como en EDO)
\usepackage{titlesec}
% Espaciado consistente de secciones y subsecciones (igual que en EDO)
\titlespacing*{\section}{0pt}{1.2em}{0.6em}
\titlespacing*{\subsection}{0pt}{1.0em}{0.3em}
\titlespacing*{\subsubsection}{0pt}{0.8em}{0.4em}
\usepackage{caption}
\usepackage{float} % Permite usar [H] para figuras

% --- Esquemas y Dibujos ---
\usepackage{tikz}
\usetikzlibrary{arrows.meta}

% Formato de subtítulos (respetamos tu jerarquía)
\titleformat{\subsection}{\normalfont\small\bfseries}{\thesubsection}{1em}{}

% --- Enlaces (al final del preámbulo, como en EDO) ---
\usepackage[hidelinks]{hyperref}

% --- Espaciado entre texto y ecuaciones (igual que en EDO afinado) ---
\AtBeginDocument{%
  \abovedisplayskip=0.8em
  \belowdisplayskip=1.0em
  \abovedisplayshortskip=0.5em
  \belowdisplayshortskip=0.7em
}
